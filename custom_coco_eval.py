...
def run_metrics(compound_coef, nms_threshold, use_cuda, use_float16, 
                override_prev_results, project_name, weights_path, confidence_threshold, max_detections, iteration):            
...
if __name__ == '__main__':
    ...
    #------------------------------------------------------------------------------------------------------------------------------    
    project_name = "apple_semi_annotated_orig"#"b_apple_8"#
    weights_path = "logs/apple_semi_annotated_orig/efficientdet-d0_trained_weights.pth"#"logs/b_apple_8_1/efficientdet-d1_trained_weights_semi.pth"#
    compound_coef = 0
    nms_threshold = 0.5
    use_cuda = True
    use_float16 = False
